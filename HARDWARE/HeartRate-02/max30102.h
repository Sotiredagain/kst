...
//#define		MAX30102_IIC_SCL_PIN		GPIO_Pin_13
//#define		MAX30102_IIC_SDA_PIN		GPIO_Pin_15

#define		MAX30102_IIC_CLK				RCC_APB2Periph_GPIOC
#define		MAX30102_IIC_PORT				GPIOC
#define		MAX30102_IIC_SCL_PIN		GPIO_Pin_11
#define		MAX30102_IIC_SDA_PIN		GPIO_Pin_10

#define MAX30102_IIC_SDA(N) (N)?GPIO_SetBits(MAX30102_IIC_PORT,MAX30102_IIC_SDA_PIN):GPIO_ResetBits(MAX30102_IIC_PORT,MAX30102_IIC_SDA_PIN);
#define MAX30102_IIC_SCL(N) (N)?GPIO_SetBits(MAX30102_IIC_PORT,MAX30102_IIC_SCL_PIN):GPIO_ResetBits(MAX30102_IIC_PORT,MAX30102_IIC_SCL_PIN);
...
//心率血氧值的读取
void GetHeartRateSpo2_init(void);//这个只需要在main函数用过一次就行
void GetHeartRateSpo2(void);//这个可以被循环调用
#endif
